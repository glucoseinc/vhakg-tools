...
def main():
    ...
    main_object: str = args.main_object
...
def get_args():
    ...
    parser.add_argument("main_object", type=str, help="The main object of an event (partially matching)")
    parser.add_argument("-t", "--target-object", type=str, help="The target object of an event (partially matching)")
    parser.add_argument("-c",  "--camera",  type=int, help="The camera number to search for (optional)")
    parser.add_argument("-s", "--segment", action='store_true', help="The flag to search for the segments of the videos")
    parser.add_argument("output_path", type=str, help="The directory to save the search results (can be relative or absolute)")
